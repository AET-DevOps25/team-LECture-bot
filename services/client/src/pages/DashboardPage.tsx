...
const DashboardPage: React.FC = () => {
    const { courseSpaces, loading, error, createCourseSpace } = useCourseSpaces();

    const [isModalOpen, setIsModalOpen] = useState(false);


    // Called by the modal on success
    const handleCourseCreated = async (name: string) => {
        const newCourseSpace = await createCourseSpace(name);
