...
jest.mock("../components/QnAChat", () => () => <div>QnAChatMock</div>);
jest.mock("../components/flashcards/FlashcardViewer", () => () => <div>FlashcardViewerMock</div>);
jest.mock("../components/PdfUpload", () => () => <div>PdfUploadMock</div>);
...
describe("CourseSpacePage", () => {
  ...
  it("shows loading initially", () => {
    require("../context/AuthContext").useAuth.mockReturnValue({ token: "t" });
    renderWithRouter();
