...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-07-16T17:04:50.711386500+02:00[Europe/Berlin]", comments = "Generator version: 7.13.0")
public class CourseSpaceDto {
  ...
  private @Nullable UserProfile owner;

  public CourseSpaceDto id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   */
  @Valid 
  @Schema(name = "created_at", example = "2023-10-01T12:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public CourseSpaceDto updatedAt(OffsetDateTime updatedAt) {
   ...
   */
  @Valid 
  @Schema(name = "updated_at", example = "2023-10-01T12:00Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public CourseSpaceDto owner(UserProfile owner) {
    this.owner = owner;
    return this;
  }
