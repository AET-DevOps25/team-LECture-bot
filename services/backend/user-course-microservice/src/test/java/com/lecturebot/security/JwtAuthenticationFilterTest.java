...
class JwtAuthenticationFilterTest {
    ...
    private static final String SECRET = "0123456789012345678901234567890123456789012345678901234567890123"; // 64 chars
    ...
    void doFilterInternal_validToken_setsAuthentication() throws ServletException, IOException {
        ...
        UserDetails userDetails = new User("testuser", "pass", java.util.List.of());
